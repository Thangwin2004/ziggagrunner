  ...
  return new Promise((resolve) => {
    if (!document.getElementById("vibrant-modal-styles")) {
      ...
      style.textContent = `
        ...
        .modal-card-wrapper { background: linear-gradient(180deg, #b266ff 0%, #5900b3 100%); padding: 6px; border-radius: 20px; box-shadow: 0 6px 0 #330066, 0 15px 30px rgba(0,0,0,0.4); position: relative; transform: scale(0.85); animation: popIn 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards; }
        .modal-card { background: #fbfaf5; border-radius: 14px; border: 2.5px solid #ffea00; padding: 45px 20px 20px 20px; width: 300px; text-align: center; position: relative; box-sizing: border-box; }
        .modal-ribbon { position: absolute; top: -20px; left: 50%; transform: translateX(-50%); width: 220px; height: 42px; background: linear-gradient(180deg, #33ccff 0%, #0088cc 100%); border: 2px solid #e6f9ff; border-radius: 10px; box-shadow: 0 4px 0 #004466, 0 4px 10px rgba(0,0,0,0.3); display: flex; justify-content: center; align-items: center; z-index: 5; }
        .modal-ribbon.pink { background: linear-gradient(180deg, #ff66b2 0%, #cc0066 100%); box-shadow: 0 4px 0 #800040, 0 4px 10px rgba(0,0,0,0.3); border-color: #ffe6f2; }
        ...
        .msg-text { font-family: 'Outfit', sans-serif; font-size: 18px; color: #360207; font-weight: bold; margin-bottom: 25px; line-height: 1.4; }
